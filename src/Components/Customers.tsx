...
export default function Customers() {
  return (
    <div className='flex gap-10 px-36 py-8 bg-neutral-silver'>
          <img src="./images/image.png" width={326} height={326} className='#' />
        ...
        <div >
         ...
         <div className='pt-1 Body-Regular-Body-2 text-neutral-l-grey'>British Dragon Boat Racing Association</div>
